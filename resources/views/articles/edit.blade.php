                ...
                <div class="p-6 text-gray-900">
                    <form action="{{route('articles.update',$article->id)}}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input type="text" name="title" id="title" value="{{old('title',$article->title)}}" class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="Enter title">
                                @error('title')
                            ...
                            <div class="my-3">
                                <input type="text" name="author" id="author" value="{{old('author',$article->author)}}" class="border-gray-300 shadow-sm w-1/2 rounded-lg" placeholder="Enter author">
                                @error('author')
                                    <p class="text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
